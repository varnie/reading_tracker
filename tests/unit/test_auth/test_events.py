...
class TestAuthServiceEvents:
    ...
    async def test_register_emits_user_registered_event(self):
        ...
        with patch("app.features.auth.service.UserRepository", return_value=mock_repo):
            with patch("app.features.auth.service.RefreshTokenRepository"):
    ...
    async def test_logout_emits_user_logged_out_event(self):
        ...
        with patch(
            ...
            with patch("app.features.auth.service.get_redis") as mock_get_redis:
